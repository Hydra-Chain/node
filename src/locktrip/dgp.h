...
enum dgp_contract_funcs {
    FINISH_VOTE = 2,
    GET_DGP_PARAM = 20,
    HAS_VOTE_IN_PROGRESS = 22,
    GET_VOTE_EXPIRATION = 21,
    PARAM_VOTED = 24,
    VOTE = 4,
    CONVERT_FIAT_THRESHOLD_TO_LOC = 6,
    ///////////////
    CURRENT_VOTE_NEWADMIN = 11,
    CURRENT_VOTE_VOTESFOR = 19,
    CURRENT_VOTE_VOTESAGAINST = 18,
    CURRENT_VOTE_STARTBLOCK = 16,
    CURRENT_VOTE_BLOCKSEXPIRATION = 12,
    CURRENT_VOTE_PARAM = 14,
    CURRENT_VOTE_VALUE = 15,
    CURRENT_VOTE_CREATOR = 13,
    CURRENT_VOTE_THRESHOLD = 17
};
