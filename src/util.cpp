...
const char * const BITCOIN_PID_FILENAME = "locktripd.pid";
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (strprintf(COPYRIGHT_HOLDERS, COPYRIGHT_HOLDERS_SUBSTITUTION).find("LockTrip") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The LockTrip developers";
    }
