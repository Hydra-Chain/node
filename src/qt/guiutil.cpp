...
void setupAddressWidget(QValidatedLineEdit *widget, QWidget *parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a LockTrip address (e.g. %1)").arg(
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("locktrip://", Qt::CaseInsensitive))
    {
        uri.replace(0, 7, "locktrip:"); // LockTrip: change string length to 7 to correctly parse locktrip://
    }
...
{
    QString ret = QString("locktrip:%1").arg(info.address);
    int paramCount = 0;
