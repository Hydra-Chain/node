...
UniValue getaddressdeltas(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1 || !request.params[0].isObject())
        throw std::runtime_error(
                ...
                "    \"address\"  (string) The locktrip encoded address\n"
                "  }\n"
                "]\n"
                "\nExamples:\n"
                + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"LPSSGeFHDnKNxiEyFrD1wcEaHr9hrQDDWc\"]}'")
                + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"LPSSGeFHDnKNxiEyFrD1wcEaHr9hrQDDWc\"]}")
        );
...
UniValue getaddressbalance(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
                ...
                "}\n"
                "\nExamples:\n"
                + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"LPSSGeFHDnKNxiEyFrD1wcEaHr9hrQDDWc\"]}'")
                + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"LPSSGeFHDnKNxiEyFrD1wcEaHr9hrQDDWc\"]}")
        );
...
UniValue getaddressutxos(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
                ...
                "]\n"
                "\nExamples:\n"
                + HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"LPSSGeFHDnKNxiEyFrD1wcEaHr9hrQDDWc\"]}'")
                + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"LPSSGeFHDnKNxiEyFrD1wcEaHr9hrQDDWc\"]}")
        );
...
UniValue getaddressmempool(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
                ...
                "]\n"
                "\nExamples:\n"
                + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"LPSSGeFHDnKNxiEyFrD1wcEaHr9hrQDDWc\"]}'")
                + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"LPSSGeFHDnKNxiEyFrD1wcEaHr9hrQDDWc\"]}")
        );
...
UniValue getaddresstxids(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
                ...
                "]\n"
                "\nExamples:\n"
                + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"LPSSGeFHDnKNxiEyFrD1wcEaHr9hrQDDWc\"]}'")
                + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"LPSSGeFHDnKNxiEyFrD1wcEaHr9hrQDDWc\"]}")
        );
