            ...
            RPCHelpMan{"validateaddress",
                ...
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        ...
                        {RPCResult::Type::STR, "address", "The HYDRA address validated"},
        ...
        throw std::runtime_error(
                RPCHelpMan{"getdgpinfo",
                           ...
                           RPCResult{
                               RPCResult::Type::OBJ, "", "",
                               {
                                   {RPCResult::Type::NUM, "burnrate", "current burn rate"},
                                   {RPCResult::Type::NUM, "economyreimbursement", "current economy reimbursement"},
                                   {RPCResult::Type::NUM, "blocksize", "current block size"},
                                   {RPCResult::Type::NUM, "blockgaslimit", "current block gas limit"},
                                   {RPCResult::Type::NUM, "fiatgasprice", "current fiat gas price in dollar satoshis (1$ = 100000000 dollar satoshi)"},
                                   {RPCResult::Type::NUM, "fiatbyteprice", "current fiat byte price in dollar satoshis (1$ = 100000000 dollar satoshi)"},
                                   {RPCResult::Type::NUM, "hydragasprice", "current gas price in HYDRA satoshis"},
                                   {RPCResult::Type::NUM, "hydrabyteprice", "current byte price in HYDRA satoshis"},
                                   {RPCResult::Type::NUM, "rewardpercentage", "current block reward percentage"},
                                   {RPCResult::Type::OBJ, "voteinfo", "",
                                       {
                                           {RPCResult::Type::BOOL, "voteinprogress", "is there a vote in progress"},
                                           {RPCResult::Type::STR, "param", "which dgp param is voted"},
                                           {RPCResult::Type::NUM, "value", "what is the voted value"},
                                           {RPCResult::Type::STR_HEX, "votecreator", "which admin address is the creator"},
                                           {RPCResult::Type::NUM, "startingblock", "vote starting block"},
                                           {RPCResult::Type::NUM, "endingblock", "vote ending block"},
                                           {RPCResult::Type::NUM, "durationblocks", "vote duration in blocks"},
                                           {RPCResult::Type::NUM, "votethreshold", "threshold in satoshis for a vote to be valid"},
                                           {RPCResult::Type::NUM, "votesfor", "count of votes for"},
                                           {RPCResult::Type::NUM, "votesagainst", "count of votes against"},
                                       },
                                   },
                               }
                           },
