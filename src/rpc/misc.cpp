    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"validateaddress",
                "\nReturn information about the given LT address.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The LT address to validate"},
                },
                RPCResult{
            "{\n"
        ...
        throw std::runtime_error(
                RPCHelpMan{"getdgpinfo",
                           ...
                           RPCResult{
                                   ...
                                   "  \"locgasprice\": xxxxx,     (numeric) current gas price in LT satoshis\n"
                                   "  \"locbyteprice\": xxxxx,     (numeric) current byte price in LT satoshis\n"
                                   "}\n"
                           },
                           RPCExamples{
        ...
        RPCHelpMan{"getaddressdeltas",
            "\nReturns all changes for an address (requires addressindex to be enabled).\n",
            {
                {"Input params", RPCArg::Type::OBJ, RPCArg::Optional::NO, "Json object",
                    {
                        {"addresses", RPCArg::Type::ARR, RPCArg::Optional::NO, "The LT addresses",
                            {
                                {"address", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "The LT address"},
                            }
                        },
        ...
        std::string msg =
            RPCHelpMan{"createmultisig",
                ...
                "It returns a json object with the address and redeemScript.\n",
                {
                    ...
                    {"keys", RPCArg::Type::ARR, RPCArg::Optional::NO, "A json array of keys which are LT addresses or hex-encoded public keys.",
                        {
                            {"key", RPCArg::Type::STR_HEX, RPCArg::Optional::OMITTED, "LT address or hex-encoded public key"},
                        }},
    ...
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            RPCHelpMan{"verifymessage",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The LT address to use for the signature."},
...
UniValue getinfo(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
                ...
                "  \"balance\": xxxxxxx,         (numeric) the total LT balance of the wallet\n"
                "  \"stake\": xxxxxxx,           (numeric) the total LT stake balance of the wallet\n"
