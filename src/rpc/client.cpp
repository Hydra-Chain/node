...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "hrc20listtransactions", 2, "fromBlock"},
    { "hrc20listtransactions", 3, "minconf"},
    //////////////////////////////////////////////////
    ...
    { "mintlydra", 1, "lockAmount" },
    { "burnlydra", 1, "unlockAmount" },
    { "addsuperstakeraddress", 0, "params" },
    { "setsuperstakervaluesforaddress", 0, "params" },
    { "hrc20approve", 4, "gasLimit" },
    { "hrc20approve", 5, "checkOutputs" },
    { "hrc20transfer", 4, "gasLimit" },
    { "hrc20transfer", 5, "checkOutputs" },
    { "hrc20transferfrom", 5, "gasLimit" },
    { "hrc20transferfrom", 6, "checkOutputs" },
    { "hrc20burn", 3, "gasLimit" },
    { "hrc20burn", 4, "checkOutputs" },
    { "hrc20burnfrom", 4, "gasLimit" },
    { "hrc20burnfrom", 5, "checkOutputs" },
