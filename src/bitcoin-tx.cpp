...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s locktrip-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  locktrip-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded locktrip transaction") + "\n" +
              "  locktrip-tx [options] -create [commands]   " + _("Create hex-encoded locktrip transaction") + "\n" +
              "\n";
