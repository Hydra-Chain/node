...
It will perform a check that if a Tx is created with OP_COINSTAKECALL,
it shall not be accepted in mempool
"""
...
class EconomyTest(BitcoinTestFramework):
    ...
    def create_unsigned_pos_block(self, staking_prevouts, nTime):
        ...
        callstring = ""
    ...
    def run_test(self):
        ...
        scriptCoinstake = CScript([0x4, bytes.fromhex(callstring), bytes.fromhex("0000000000000000000000000000000000000090"), OP_COINSTAKE_CALL])
        ...
        addcontract_tx.vout.append(CTxOut(0, scriptCoinstake))
